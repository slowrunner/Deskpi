...
from sim.I2C_mutex import Mutex
from math import pi
...
try:
    ...
    from sim.di_sensors import easy_distance_sensor
    # print("egpg import easy_distance_sensor success")
...
# print("easygopigo.py: di_sensors_available:{}".format(di_sensors_available))
