...
class DistanceSensor(object):
    ...
    def start_continuous(self, period_ms = 0):
        ...
        simLog.logger.info("sim.distance_sensor.start_continuous() called")
    ...
    def read_range_single(self, safe_infinity=True):
        ...
        """
        simLog.logger.info("sim.distance_sensor.read_range_single() called")
    ...
    def timeout_occurred(self):
        ...
        """
        simLog.logger.info("sim.distance_sensor.timeout_occurred() called")
