...
#
# Modified: Alan McDonley Nov 2020
#  algorithm -> algorithm
#
...
'''
import huskylib
# choose serial over USB (uncomment desired method)
# huskylens = huskylib.HuskyLensLibrary("SERIAL", "/dev/ttyUSB0", 3000000)
# or choose I2C
# huskyLens = huskylib.HuskyLensLibrary("I2C","",address=0x32)
